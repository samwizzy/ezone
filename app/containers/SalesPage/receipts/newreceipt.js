...
const NewReceipt = () => {
  ...
  const receiptsContext = useContext(ReceiptContext);
                          ...
                          <div>
                            <div style={{ float: 'right' }}>
                              <Grid container spacing={1}>
                                <Grid item>
                                  <div className={classes.controlButton}>
                                    <Button
                                      size="small"
                                      onClick={() => {
                                        receiptsContext.receiptDispatch({
                                          type: 'NAVIGATION',
                                          page: 'receipt',
                                        });
                                      }}
                                ...
                                size={'small'}
                                color="primary"
                                onClick={()=>{receiptsContext.invoiceDispatch({type:'NAVIGATION',page:'invoicereciept'})}}
                                variant="contained">
                                 Save and Sumbit
                                </Button>
                                 </div> */}
