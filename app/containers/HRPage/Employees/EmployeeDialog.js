  ...
  return (
    ...
    >
      <DialogTitle id="alert-dialog-slide-title">
        {empDialog.type === 'new' ? '' : 'Update employee'}
      </DialogTitle>
        ...
        <Grid container spacing={1}>
          ...
          <Grid item xs={5}>
            <TextField
              ...
              onChange={handleChange}
            >
              <MenuItem value="">Select employee status</MenuItem>
          ...
          <Grid item xs={6}>
            <Autocomplete
              ...
              value={
                values.branch
                  ? _.find(branches, { id: values.branch.id })
                  : null
              }
          ...
          <Grid item xs={6}>
            <Autocomplete
              ...
              value={
                values.department
                  ? _.find(departments, { id: values.department.id })
                  : null
              }
