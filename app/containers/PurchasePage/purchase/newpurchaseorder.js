                ...
                <Paper className={classes.pap} elevation={2}>
                  ...
                  /> 
                      ...
                      <TextField style={{ width: '100%' }} id="filled-basic"
                       size={'small'} label="Purchase Order number" variant="outlined" />
                      </Grid>
                       ...
                       <Grid item xs={12}>
                         ...
                         <Grid container spacing={1}>
                           ...
                           <div className={classes.controlButton}>
                                <Button
                                size={'small'}
                                onClick={()=>{purchaseContext.purchaseDispatch({type:'NAVIGATION',page:'purchaseorder'})}}
                                variant="contained">
                                 Cancel
                                </Button>
                                 </div>
                           ...
                           <div className={classes.controlButton}>
                                ...
                                size={'small'}
                                color="primary"
                                onClick={()=>{purchaseContext.purchaseDispatch({type:'NAVIGATION',page:'newshipment'})}}
                                variant="contained">
                                 Save and Sumbit
                                </Button>
                                 </div>
