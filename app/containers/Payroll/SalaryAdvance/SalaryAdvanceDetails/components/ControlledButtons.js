...
const ControlledButtons = props => {
  ...
  const { history, match, bankAccount, openEditSalaryAdvanceDialog, openDeleteSalaryAdvanceDialog } = props;
  ...
  return (
    <div className={classes.root}>
      <Toolbar className={classes.iconPaper} variant="dense">
        ...
        <IconButton onClick={() => openEditSalaryAdvanceDialog(bankAccount)}>
          <Icon>edit</Icon>
        </IconButton>
        <IconButton onClick={() => openDeleteSalaryAdvanceDialog(bankAccount)}>
          <Icon>delete</Icon>
        </IconButton>
      </Toolbar>
    </div>
