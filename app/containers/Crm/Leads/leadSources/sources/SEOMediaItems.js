...
const seos = [
	{ name: 'Google', icon: 'mail_outline' },
	{ name: 'Bing', icon: 'mail_outline' },
]

const SEOMediaItems = props => {
	...
	return (
		<React.Fragment>
			<Toolbar variant="dense" className={classes.toolbar}>
				<Typography variant="h6" className={classes.title}>Search Engine</Typography>
