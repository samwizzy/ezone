...
export function* getAllCrmActivities() {
  ...
  try {
    const getAllCrmActivitiesResponse = yield call(request, requestURL, {
      method: 'GET',
      headers: new Headers({
    ...
    console.log(getAllCrmActivitiesResponse, 'getAllCrmActivitiesResponse');
    yield put(Actions.getAllCrmActivitiesSuccess(getAllCrmActivitiesResponse));
  } catch (err) {
