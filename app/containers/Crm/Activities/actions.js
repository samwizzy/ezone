...
export function createCrmActivity(payload) {
  return {
    type: Constants.CREATE_CRM_ACTIVITY,
    payload
  }
}

export function createCrmActivitySuccess(data) {
  return {
    type: Constants.CREATE_CRM_ACTIVITY_SUCCESS,
    payload: data,
  }
}

export function createCrmActivityError(data) {
  return {
    type: Constants.CREATE_CRM_ACTIVITY_ERROR,
    payload: data,
  }
}
