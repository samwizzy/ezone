				...
				? (
					<div>
						...
						>
							...
							<TableBody>
								...
								<TableRow key={transferOrder.title}>
									...
									<TableCell align="right">{transferOrder.transferredBy}</TableCell>
								</TableRow>
								<TableRow key={transferOrder.title}>
						...
						>
							...
							<TableBody>
								<TableRow key={transferOrder.title}>
									<TableCell component="th" scope="row">{transferOrder.sourceWarehouse}</TableCell>
									<TableCell align="right">{transferOrder.destinationWarehouse}</TableCell>
								</TableRow>
							</TableBody>
						</Table>
