...
const Print = ({ height, width, className, printRef }) => {
  ...
  return (
    <div onClick={handlePrint} className={className}>
      ...
      >
        <g>
          <g>
            <path
              d="M460.8,119.467h-85.333v-102.4C375.467,7.641,367.826,0,358.4,0H119.467C110.041,0,102.4,7.641,102.4,17.067v102.4H17.067
    ...
    c-9.426,0-17.067,7.641-17.067,17.067s7.641,17.067,17.067,17.067H102.4v51.2H34.133V153.6h409.6V341.333z"
        ...
        <g>
          <g>
            <path
              d="M409.6,187.733h-17.067c-9.426,0-17.067,7.641-17.067,17.067s7.641,17.067,17.067,17.067H409.6
    c9.426,0,17.067-7.641,17.067-17.067S419.026,187.733,409.6,187.733z"
        ...
        <g>
          <g>
            <path
              d="M290.133,324.267h-102.4c-9.426,0-17.067,7.641-17.067,17.067s7.641,17.067,17.067,17.067h102.4
    c9.426,0,17.067-7.641,17.067-17.067S299.559,324.267,290.133,324.267z"
        ...
        <g>
          <g>
            <path
              d="M290.133,375.467h-102.4c-9.426,0-17.067,7.641-17.067,17.067s7.641,17.067,17.067,17.067h102.4
