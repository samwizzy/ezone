      ...
      <Grid container>
        <Grid item xs={12}>
          ...
          <Toolbar className={classes.toolbar}>
            <EventAvailableIcon />
            <Typography variant="h6" className={classes.title}>Accounting Period</Typography>
          </Toolbar>
        ...
        <Grid item xs={12}>
          <Toolbar className={classes.toolbar}>
            <EventAvailableIcon />
            <Typography variant="h6" className={classes.title}>Accounting Year</Typography>
          ...
          <Paper square className={classes.paper}>
            ...
            <Table size="small" className={classes.table}>
              <TableBody>
                {accountingPeriods && accountingPeriods.map((item, i) => (
                  <TableRow key={i}>
