const SidebarConfig = [
    ...
    },
    {
        ...
        menus: [
            ...
            { id: 4, name: 'Employees',    url: '/users/employees', icon: 'person' },
            { id: 5, name: 'User Profile', url: '/users/profile', icon: 'person' },
            { id: 6, name: 'WorkOrder',    url: '/workorder', icon: 'person' },
    ...
    {    
        ...
        menus: [
            { id: 1, name: 'Dashboard',    url: '/dashboard', icon: 'dashboard' },
            { id: 2, name: 'Organization', url: '/dashboard', icon: 'business_center' },
