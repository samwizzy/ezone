...
export const GetChartOfAccountByIdApi = `${BaseUrl}/accountingserv//api/v1/account/get_account_by_id`;
...
export const GetBankAccountByIdApi = `${BaseUrl}/accountingserv/api/v1/bank/get_bank_account_by_id`;
...
export const GetJournalListApi = `${BaseUrl}/accountingserv/api/v1/journal/get_journals_by_orgid`;
export const GetJournalByIdApi = `${BaseUrl}/accountingserv/api/v1/journal/get_journals_by_id`;
...
export const ActivateDeactivateBankAccountApi = `${BaseUrl}/accountingserv/api/v1/bank/acivate_or_deactivate_bank`;
export const AddDepreciationAreaApi = `${BaseUrl}/accountingserv/api/v1/area/add`;
export const GetDepreciationAreaByIdApi = `${BaseUrl}/accountingserv/api/v1/area/get_depreciation_area_by_id`;
export const GetDepreciationAreaByOrgIdApi = `${BaseUrl}/accountingserv/api/v1/area/get_depreciation_area_by_orgid`;
export const UpdateDepreciationAreaApi = `${BaseUrl}/accountingserv/api/v1/area/update`;
export const AddDepreciationTypeApi = `${BaseUrl}/accountingserv/api/v1/type/add`;
export const GetDepreciationTypeByIdApi = `${BaseUrl}/accountingserv/api/v1/type/get_depreciation_type_by_id`;
export const GetDepreciationTypeByOrgIdApi = `${BaseUrl}/accountingserv/api/v1/type/get_depreciation_type_by_orgid`;
export const UpdateDepreciationTypeApi = `${BaseUrl}/accountingserv/api/v1/type/update`;
export const AddAssetApi = `${BaseUrl}/accountingserv/api/v1/asset/add`;
export const UpdateAssetApi = `${BaseUrl}/accountingserv/api/v1/asset/update`;
...
export const AddTaxApi = `${BaseUrl}/accountingserv/api/v1/tax/add`;
export const UpdateTaxApi = `${BaseUrl}/accountingserv/api/v1/tax/update`;
export const GetTaxByIdApi = `${BaseUrl}/accountingserv/api/v1/tax/get_by_id`;
export const GetTaxesByOrgIdApi = `${BaseUrl}/accountingserv/api/v1/tax/get_by_orgid`;
...
export const UpdateItemApi = `${BaseUrl}/inventoryserv/api/v1/update_item`;
...
export const UpdateItemGroupApi = `${BaseUrl}/inventoryserv/api/v1/update_item_group`;
